...
class Cgdb(AutotoolsPackage):
    ...
    version("0.8.0-1",
            url="https://github.com/cgdb/cgdb/archive/aafd7206a5d61c72536948a138e9c1ecf30b7386.tar.gz",
            sha256="f9fc9d0adaac5b936e754637c650886b8712725f4c05aad9727fe75fe4bcec79")
    ...
    depends_on("autoconf", type="build", when="@0.8.0-1")
    depends_on("automake", type="build", when="@0.8.0-1")
    depends_on("libtool", type="build", when="@0.8.0-1")
    depends_on("m4", type="build", when="@0.8.0-1")
